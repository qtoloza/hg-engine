...
.include "armips/scr_seq/event_D24R0203.inc"


// text archive to grab from: 003.txt

.create "build/a012/2_040", 0


scrdef scr_seq_D24R0203_000
scrdef scr_seq_D24R0203_001
scrdef scr_seq_D24R0203_002
scrdef_end

scr_seq_D24R0203_000:
...
scr_seq_D24R0203_001:
	compare VAR_UNK_40CD, 1
	goto_if_ne _0060
...
_017E:
	...
	wait_fade
	warp MAP_D24R0205, 0, 25, 6, VAR_SPECIAL_RESULT
...
_01C4:
	fade_screen 6, 1, 0, RGB_BLACK
	wait_fade
	warp MAP_D24R0218, 0, 25, 6, VAR_SPECIAL_RESULT
	fade_screen 6, 1, 1, RGB_BLACK
	wait_fade
	goto _01C0
...
_01EE:
	fade_screen 6, 1, 0, RGB_BLACK
	wait_fade
	warp MAP_D24R0216, 0, 25, 6, VAR_SPECIAL_RESULT
	fade_screen 6, 1, 1, RGB_BLACK
	wait_fade
	goto _01C0
