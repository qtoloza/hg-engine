...
_034C:
	goto_if_no_item_space ITEM_TM58, 1, _0918
...
_03D5:
	goto_if_no_item_space ITEM_TM32, 1, _0918
	buffer_item_name 0, VAR_SPECIAL_x8004
	npc_msg 12
	getmenuchoice VAR_SPECIAL_RESULT
	compare VAR_SPECIAL_RESULT, 0
...
_045E:
	goto_if_no_item_space ITEM_TM10, 1, _0918
	buffer_item_name 0, VAR_SPECIAL_x8004
	npc_msg 12
	getmenuchoice VAR_SPECIAL_RESULT
	compare VAR_SPECIAL_RESULT, 0
...
_04E7:
	goto_if_no_item_space ITEM_TM29, 1, _0918
	buffer_item_name 0, VAR_SPECIAL_x8004
	npc_msg 12
	getmenuchoice VAR_SPECIAL_RESULT
	compare VAR_SPECIAL_RESULT, 0
...
_0570:
	goto_if_no_item_space ITEM_TM74, 1, _0918
	buffer_item_name 0, VAR_SPECIAL_x8004
	npc_msg 12
	getmenuchoice VAR_SPECIAL_RESULT
	compare VAR_SPECIAL_RESULT, 0
...
_05F9:
	goto_if_no_item_space ITEM_TM68, 1, _0918
	buffer_item_name 0, VAR_SPECIAL_x8004
	npc_msg 12
	getmenuchoice VAR_SPECIAL_RESULT
	compare VAR_SPECIAL_RESULT, 0
