...
scr_seq_T06R0301_000:
	...
	lockall
	faceplayer
	goto_if_unset FLAG_GOT_RARE_CANDY_FROM_FAN_CLUB_CHAIRMAN, _0137
...
scr_seq_T06R0301_002:
	...
	compare VAR_SPECIAL_RESULT, 0
	goto_if_ne _0186
	goto_if_set FLAG_UNK_119, _0191
	goto_if_set FLAG_RESTORED_POWER, _01BC
	npc_msg 9
	wait_button_or_walk_away
	closemsg
	releaseall
...
scr_seq_T06R0301_007:
	goto_if_set FLAG_HIDE_VERMILION_FAN_CLUB_LOST_ITEM, _01C7
	simple_npc_msg 15
	end
...
scr_seq_T06R0301_008:
	play_se SEQ_SE_DP_SELECT
	lockall
	faceplayer
	play_cry SPECIES_RAPIDASH, 0
	npc_msg 19
	wait_cry
	wait_button_or_walk_away
	closemsg
...
_0137:
	...
	goto_if_eq _01C9
	npc_msg 1
	goto_if_no_item_space ITEM_RARE_CANDY, 1, _01D4
