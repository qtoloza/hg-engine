...
u16 sCherrygroveCityMart[] = {
    ITEM_AIR_MAIL, ITEM_HEAL_BALL,
    ITEM_FIRE_STONE, ITEM_LEAF_STONE,
    0xFFFF
};

u16 sVioletCityMart[] = {
    ITEM_TUNNEL_MAIL, ITEM_HEAL_BALL, ITEM_NET_BALL,
    ITEM_WATER_STONE, ITEM_THUNDER_STONE,
    0xFFFF
};

u16 sAzaleaCityMart[] = {
    ITEM_BLOOM_MAIL, ITEM_HEAL_BALL, ITEM_NET_BALL,
...
u16 sEcruteakMart[] = {
    ITEM_HEART_MAIL, ITEM_HEAL_BALL, ITEM_NET_BALL,
    ITEM_DUSK_STONE, ITEM_AUBADE_ORB, ITEM_SERENADE_ORB,
    0xFFFF
};

u16 sOlivineMart[] = {
    ITEM_HEART_MAIL, ITEM_HEAL_BALL, ITEM_NET_BALL,
    ITEM_DAWN_STONE, ITEM_DEEP_SEA_SCALE, ITEM_DEEP_SEA_TOOTH,
    0xFFFF
};

u16 sCianwoodPharmacy[] = {
    ITEM_POTION, ITEM_SUPER_POTION, ITEM_HYPER_POTION, ITEM_FULL_HEAL, ITEM_REVIVE,
    ITEM_RAZOR_CLAW, ITEM_RAZOR_FANG,
    0xFFFF
};

u16 sBlackthornAndBattleFrontierMart[] = {
    ITEM_AIR_MAIL, ITEM_NET_BALL, ITEM_DUSK_BALL,
    ITEM_DRAGON_SCALE, ITEM_ICE_STONE,
    0xFFFF
};

u16 sIndigoPlateau[] = {
    ITEM_ULTRA_BALL, ITEM_MAX_REPEL, ITEM_HYPER_POTION, ITEM_MAX_POTION, ITEM_FULL_RESTORE, ITEM_REVIVE, ITEM_FULL_HEAL,
    ITEM_LINKING_CORD, ITEM_SHINY_STONE,
    0xFFFF
};

u16 sVermilionAndSafariMart[] = {
    ITEM_AIR_MAIL, ITEM_NEST_BALL, ITEM_DUSK_BALL, ITEM_QUICK_BALL,
    ITEM_UP_GRADE, ITEM_DUBIOUS_DISC,
    0xFFFF
};

u16 sSaffronMart[] = {
    ITEM_AIR_MAIL, ITEM_DUSK_BALL, ITEM_QUICK_BALL,
    ITEM_METAL_COAT, ITEM_ELECTIRIZER, ITEM_MAGMARIZER,
    0xFFFF
};
...
u16 sCeruleanMart[] = {
    ITEM_AIR_MAIL, ITEM_QUICK_BALL,
    ITEM_PROTECTOR, ITEM_PRISM_SCALE,
    0xFFFF
};
...
u16 sFuschiaMart[] = {
    ITEM_STEEL_MAIL, ITEM_DUSK_BALL, ITEM_QUICK_BALL,
    ITEM_KINGS_ROCK, ITEM_OVAL_STONE,
    0xFFFF
};
...
u16 sMtMoonSquare[] = {
    ITEM_POKE_DOLL, ITEM_FRESH_WATER, ITEM_SODA_POP, ITEM_LEMONADE, ITEM_REPEL, ITEM_HEART_MAIL,
    ITEM_MOON_STONE,
    0xFFFF
};
